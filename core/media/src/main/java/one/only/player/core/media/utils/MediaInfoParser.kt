...
package one.only.player.core.media.utils
...
object MediaInfoParser {
    ...
    private fun stripBracketsAndExtension(text: String): String = text
    ...
    private fun finalCleanup(title: String): String = title
